...
export const FirstAvatar = ({ avatarSrc, name, institute }: PodiumAvatarProps) => {
    return (
        <div className="pt-[8.5rem] pb-[30%]">
            <div className="rounded-full max-lg:w-[280px] lg:w-[370px] max-lg:h-[285px] lg:h-[370px] bg-[#D5AF26] flex items-center justify-center relative">
                ...
                <Image src={getAsset("/Pp-boy1.png")} alt="" width={350} height={350} className="rounded-full" />
                <div className="absolute max-lg:bottom-[-19%] lg:bottom-[-14%] w-full flex flex-col items-center">
                    <NameTag name={name} institute={institute} />
                </div>
            </div>
        </div>
    )
...
export const SecondAvatar = ({ avatarSrc, name, institute }: PodiumAvatarProps) => {
    return (
        <div className="pt-[8.5rem] pb-[38%] px-[40px]">
            <div className="rounded-full w-[280px] h-[285px] bg-[#D5AF26] flex items-center justify-center relative">
                ...
                <Image src={getAsset("/Pp-boy1.png")} alt="" width={275} height={280} className="rounded-full" />
...
export const ThirdAvatar = ({ avatarSrc, name, institute }: PodiumAvatarProps) => {
    return (
        <div className="pt-[8.5rem] pb-[38%] px-[40px]">
            <div className="rounded-full w-[280px] h-[285px] bg-[#D5AF26] flex items-center justify-center relative">
...
export const FirstAvatarMobile = ({ avatarSrc, name, institute }: PodiumAvatarProps) => {
    return (
        <div className="pt-[5rem] px-[30px] pb-[2rem]">
            <div className="rounded-full w-[200px] h-[200px] bg-[#D5AF26] flex items-center justify-center relative">
                ...
                <div className="absolute bottom-[-26%] w-full flex flex-col items-center">
                    <NameTagMobile name={name} institute={institute} />
                </div>
            </div>
        </div>
    )
...
export const SecondAvatarMobile = ({ avatarSrc, name, institute }: PodiumAvatarProps) => {
    return (
        <div className="pt-[6rem] px-[30px] pb-[2rem]">
            <div className="rounded-full w-[200px] h-[200px] bg-[#D5AF26] flex items-center justify-center relative">
                ...
                <Image src={getAsset("/Pp-boy1.png")} alt="" width={194} height={194} className="rounded-full" />
                <div className="absolute bottom-[-26%] w-full flex flex-col items-center">
                    <NameTagMobile name={name} institute={institute} />
                </div>
            </div>
...
export const ThirdAvatarMobile = ({ avatarSrc, name, institute }: PodiumAvatarProps) => {
    return (
