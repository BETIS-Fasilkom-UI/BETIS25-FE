    ...
    return (
        <div className="pt-[8.5rem] pb-[30%]">
            <div className="rounded-full max-lg:w-[280px] lg:w-[370px] max-lg:h-[285px] lg:h-[370px] bg-[#D5AF26] flex items-center justify-center relative">
                <Image src={'/PodiumHat-1.png'} width={200} height={160} alt="" className="lg:hidden z-10 absolute top-[-6.7rem] left-[14%]" />
                <Image src={'/PodiumHat-1.png'} width={277} height={204} alt="" className="max-lg:hidden z-10 absolute top-[-8.5rem] left-[12%]" />
