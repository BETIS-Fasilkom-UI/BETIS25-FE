          ...
          <div className="flex gap-10 py-6 sm:py-12 px-3.5  md:px-3  ">
            {slides.map((slide, index) => (
              <div className="relative" key={index}>
                <Card
                  className={cn(
                    "w-full lg:w-[30vw] border-0 shadow-[0px_0px_12px_rgba(255,255,255,0.60)] slide-image relative transition-all duration-300 ease-in-out bg-[#ffffff] rounded-[32px] px-[4.5vmin] pt-[6vmin] sm:px-8 sm:pt-10 sm:pb-8 flex flex-col justify-center items-center"
                  )}
                >
