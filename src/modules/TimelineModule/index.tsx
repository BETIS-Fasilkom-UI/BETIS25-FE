...
const TimelineModule = () => {
    return (
        <div
            className="w-full flex flex-col items-center pb-[45vh]"
        >
            ...
            <div className="flex-1 flex flex-col gap-0 items-center pt-[45%]">
                ...
                >
                    <div className={`z-10 absolute 
                        ...
                        <Image className="" src="/TreasureChest.png" alt="" layout="fill" loading="eager" />
                    </div>
                    ...
                    events.map((event, idx) =>
                        <div
                            ...
                            className={`w-0 
                                ${idx == events.length - 1
                                    ? 'h-0'
                                    : 'max-md:h-[60px] max-md:border-[2.5px] md:h-[100px] md:border-[4.5px] lg:h-[140px] lg:border-[6.5px]'} 
                                ${event.status === 'Done' ? 'border-[#FCFFCCCC]' : 'border-[#FCFFCC4D]'} 
                                shadow-timeline relative 
                                ${(idx == events.length - 1) || (events[idx + 1].status !== 'Done')
                        ...
                        >
                            ...
                            <EventCard
                                className={`absolute 
                                    max-md:top-[-25px] md:top-[-37px] lg:top-[-53px] 
                                    ${idx % 2 == 0 ? 'max-md:left-[25px] md:left-[48px] lg:left-[68px]' : 'max-md:right-[25px] md:right-[48px] lg:right-[68px]'}`}
                                event={event}
                            />
                        </div>
                    )
            ...
            <div className="flex-1 flex flex-col gap-0 items-center">
                <div className="relative">
                    <div className={`z-20 absolute 
                        ...
                        lg:right-[-45vw] lg:top-[-5vw] lg:w-[280px] lg:h-[337px]`}
                    >
