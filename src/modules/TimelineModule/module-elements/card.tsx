...
export default function EventCard({event, ...props}: JSX.IntrinsicAttributes & {event: EventEntry}) {
    return (
        <div className="h-[156px] w-[392px] px-[36px] py-[30px] flex flex-col gap-[10px] justify-center items-center bg-[#6F4589] border shadow-event-entry-card rounded-[32px]">
