...
const MedparModule = () => {
    ...
    return (
        <div className="hidden lg:flex mt-48 flex flex-col items-center space-y-6">
            {/* Title */}
            <h1 className="text-4xl font-cinzel text-white">Our Media Partners</h1>
