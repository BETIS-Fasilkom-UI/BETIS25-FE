    ...
    >
      ...
      {!disabled && (
        <div className={tooltipClasses}>
          <span className="bg-gradient-to-b from-violet-tooltip to-violet-tooltip-darker bg-clip-text text-transparent">{text}</span>
      ...
      {disabled && (
        <div className={tooltipClasses}>
          <span className="bg-gradient-to-b from-violet-tooltip to-violet-tooltip-darker bg-clip-text text-transparent">disabled</span>
          <div className={pointerClasses} />
        </div>
      )}
    </div>
