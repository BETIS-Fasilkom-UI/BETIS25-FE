...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border-white bg-foreground bg-opacity-15 backdrop-blur-[2px] shadow-[0_0px_18px_#ffffff] py-7 px-6 lg:py-11 lg:px-10 rounded-[2rem] border-[0.031rem] space-y-5",
      className
    )}
    {...props}
  />
