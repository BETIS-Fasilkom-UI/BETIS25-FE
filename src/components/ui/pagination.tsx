...
const Pagination: React.FC<PaginationProps> = ({ 
  ...
  return (
    <div className={cn("inline-flex items-center justify-center rounded-full bg-gradient-to-b from-tosca-pagination to-tosca-pagination-darker py-2 px-4 md:px-5 lg:py-3 lg:px-6", paginationClass)}>
      <button
