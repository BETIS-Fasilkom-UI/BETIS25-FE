  ...
  (
    ...
    return (
      <div className='flex flex-col gap-2'>
        ...
        <div className='flex items-center border-2 border-gray-500 rounded-[0.5rem] w-full text-black outline-none overflow-hidden relative'>
          ...
          <input
            ...
            ref={ref}
            className={cn(
              'w-full h-full rounded-[0.5rem] bg-white outline-none px-5 py-3 duration-300 text-t9 sm:text-t7',
